// Matrix Search
// Code by: O. Blankenship
// Initial Version Date: 2/22/2021
// Course: CS 1337.003
...
// Changelog:
//  2/22/21
//	1. Initial version. Created file handing, matrix creation, and word list creation functions.
//  2/23/21
//  1. Added core matrix search functions.
//  2. Added debug functions to allow reading from test files within the program directory.
//  2/24/21
//  1. Added corrections for handling words with spaces.
//  2. Added functions for handling reporting of found words as well as their positions and directions.
//  2/25/21
//  1. Added the option for users to search for custom words.
//  2. Corrected to handle for lower case letters since users are likely to input them in the custom search.
//  2/26/21
//  1. Corrected an issue with reporting for custom search where the last word from the word list was being reported as a custom search entry.
//  2. Added ability to enable/disable reporting of multiple found instances of a given word from the debug menu.
//  3. Clean up file open function to give an error message on invalid file name.
//  4. Added ability to show/hide word list in debug menu.
//  3/11/21
//  1. Added functionality to notate which positions contained found letters
//  3/12/21
//  1. Added functions to generate PPM files based on various criteria. See GeneratePPM functions for details on generation methods.
// Notes:
//  SPECIAL FEATURE: Added ability to allow users to search for custom words in the matrix. Search is case-insensitive allowing users to use lower case letters. (#12)
//  SPECIAL FEATURE: Added ability to enable/disable reporting of multiple found instances of a given word from the debug menu. (#11)
